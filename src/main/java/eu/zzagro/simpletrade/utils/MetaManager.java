...
public class MetaManager {
    ...
    public ItemStack emptyItem = new ItemStack(Material.STAINED_GLASS_PANE, 1, (short) 7);
    public ItemStack confirmItem = new ItemStack(Material.STAINED_GLASS_PANE, 1, (short) 5);
    public ItemStack cancelTradeItem = new ItemStack(Material.BARRIER);
    public ItemStack waitingItem = new ItemStack(Material.STAINED_GLASS_PANE, 1, (short) 1);
    public ItemStack readyItem = new ItemStack(Material.STAINED_GLASS_PANE, 1, (short) 5);
